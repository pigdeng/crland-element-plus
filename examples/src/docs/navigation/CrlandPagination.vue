<template>
  <div class="doc-wrap">
    <h2 class="title">Pagination 分页</h2>
    <p>
      当数据量过多时，使用分页分解数据。本组件对
      <el-tag class="ml-2" type="info">el-pagination</el-tag>
      进行了简化封装。
    </p>
    <!-- <el-divider /> -->
    <h3>使用规则</h3>
    ...
    <h3>代码演示</h3>
    <crland-code-show fileUrl="/code/navigation/CrlandPagination.txt">
      <CrlandPaginationDemo style="width: 90%" />
    </crland-code-show>
