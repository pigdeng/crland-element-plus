<template>
    <el-row class="mb-4">
        <crland-button shadow type="primary" @click="getHtml">获取 html</crland-button>
        <crland-button shadow type="success" @click="setEdit"> {{ !disabled ? '设置不可编辑' : '设置可编辑' }}</crland-button>
    </el-row>
    <br />
...
import { CrlandTinymceEditor, CrlandButton } from "bui-element-plus";
